...
# Perintah baru untuk mengatasi PermissionError secara paksa
...
CMD ["streamlit", "run", "kms_wfa_lhfa_bfa_hcfa_acfa_wflh-st-0_1.py", "--server.port=7860", "--server.headless=true"]