...
# ... (Lakukan pola yang sama untuk handle_bmi_for_age, handle_length_for_age, dan handle_head_circumference_for_age)
# ... (Untuk keringkasan, fungsi lainnya tidak disertakan di sini, tetapi Anda harus memodifikasinya dengan pola yang sama)
