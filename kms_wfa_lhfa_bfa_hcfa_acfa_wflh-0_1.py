...
def handle_weight_for_age():
    """Fungsi utama untuk menangani semua logika kurva Berat Badan vs Umur."""
    try:
...
def main_menu():
    """Menampilkan menu utama untuk memilih jenis kurva."""
    while True:
        print("\n=============================================")
        print("   PROGRAM PLOT KURVA PERTUMBUHAN ANAK WHO   ")
        print("=============================================")
        print("Pilih jenis kurva yang ingin ditampilkan:")
        print("1. Berat Badan menurut UMUR (Weight-for-Age)")
        print("2. Berat Badan menurut TINGGI/PANJANG BADAN (Weight-for-Height/Length)")
        print("3. IMT menurut UMUR (BMI-for-Age)")
        print("4. Panjang/Tinggi Badan menurut UMUR (Length/Height-for-Age)") # <-- BARU
        print("5. Lingkar Kepala menurut UMUR (Head Circumference-for-Age)") # <-- BARU
        print("6. Keluar") # <-- BARU
        ...
        if pilihan == '1':
            ...
            handle_bmi_for_age() # Panggil fungsi baru
        elif pilihan == '4':
            handle_length_for_age() # Panggil fungsi baru
        elif pilihan == '5':
            handle_head_circumference_for_age() # <-- Panggil fungsi baru
        elif pilihan == '6':
